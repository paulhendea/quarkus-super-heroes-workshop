...
public class HeroResourceTest {
    ...
    void shouldAddAnItem() {
        ...
        // call endpoint to create the hero
        ...
        // call endpoint to make sure the hero was created
        given()
            .pathParam("id", heroId)
            .when().get("/api/heroes/{id}")
            .then()
        ...
        // call endpoint to make sure the total number of hero is +1
        List<Hero> heroes = get("/api/heroes")
            .then()
            .statusCode(OK.getStatusCode())
            .extract().body().as(getHeroTypeRef())
